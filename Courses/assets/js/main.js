...
// function user (){
//     let newData = users.filter((item) => item.role == "user")
//     console.log(newData); 

//     let Database = users.filter((item) => item.role == "admin")
//     console.log(Database);

//     let danielcpass = users.filter ((item) => item.role == "moderator")
//     console.log(danielcpass);
// }
// user()
...
//     let Delaware = users.filter((item) => item.company.department == "Accounting")
...
// function mail (){
//     let network = users.filter ((item) => item.email [item.email .length -9] == "g")
//     console.log(network);
// }
// mail()
